...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the node to be removed is the head, call RemoveHead.
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If the node to be removed is the tail, call RemoveTail.
                else if (curr == _tail)
                {
                    RemoveTail();
                }
                // For any other location, adjust the links to remove the node.
                else
                {
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        // Search for nodes that match 'oldValue' by starting at the head of the list.
        Node? curr = _head;
        while (curr is not null)
        {
